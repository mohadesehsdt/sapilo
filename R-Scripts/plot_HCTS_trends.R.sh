...
custom_colors <- c(
"orange", "red", "darkgreen", "darkblue",
"lightblue", "lightgreen", "black", "brown", "purple"
)
# Read the data
data <- read.delim("relativeabundance_HCTS_R_filtered.txt", header = TRUE, sep = "\t", stringsAsFactors = FALSE)
# Prepare data
data_clean <- data %>%
...
labs(
title = "Relative Abundance of Each Bin of genus Poseidonia Across Samples from HCTS",
x = "Sample",
